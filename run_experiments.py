...
from tensorflow.keras.layers import Input, Embedding, LSTM, Dense, TimeDistributed, Masking, RepeatVector, concatenate, Flatten
from tensorflow.keras.models import Model
...
if __name__=="__main__":
    ...
    print(FLAGS)
    if type(FLAGS.num_windows) is int:
        FLAGS.num_windows=[FLAGS.num_windows] 
